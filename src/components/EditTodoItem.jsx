...
const EditTodoItem = ({ todo, index, onClickEditSave }) => {
  ...
  return (
    <>
      <li key={todo.id} className="flex justify-between items-center border p-2">
        ...
        <button onClick={() => onClickEditSave(index, inputTitle)} className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded ml-2">
          保存
        </button>
      </li>
    </>
